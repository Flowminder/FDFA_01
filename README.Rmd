...
The dataset has been developped by Alessandro Sorichetta (PI)^1^, Andrew J. Tatem (PI) ^1^ ^3^, Silvia Ceausu ^1^, Dorothea Woods ^1^ ^2^, Chigozie E. Utazi ^1^ and Guy Abel ^4^. The dashboard has been developped by Xavier Vollenweider ^3^.
<br>
<br>
<br>
