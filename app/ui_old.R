...
# Headings and dividors 
title1_html=htmlOutput("title1")

title2_html=htmlOutput("title2")

title3_html=htmlOutput("title3")

title4_html=htmlOutput("title4")

line_1_html = HTML("<hr color='black' >",
                   "<hr size='30' >",
                   "<border=0>")
...
leaflet_map3=leafletOutput("map3",width="100%",height="800px")
