...
<center>
```{r census-year-LAC, echo=FALSE, warning=FALSE,fig.cap="Map 1: Study area split into countries with and without IPUMSI census data", out.width = '100%'}
...
```{r male-model, echo=FALSE, warning=FALSE,message=FALSE, fig.cap="Figure 2: Male migration, goodness of fit as measured by the average of the squared rank correlation coefficient (R-squared). A value of 60% means that 60% of the variation in the observed data on male migration movements is explained by the model.", out.width='600px', fig.show='hold',align='center'}
