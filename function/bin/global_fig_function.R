global_fig_function=function(mig_db){
  ...
  HTML("<h4>",
       "<p><b> International migrants:</b>",int_mig,"</p>",
       ...
       "<br>",
       "<p><b>Top countries for internal migration:</b>", "<p>",top_1_nat,"</p>","<p>",top_2_nat,"</p>","<p>",top_3_nat,"</p>",
       "</h4>")
}