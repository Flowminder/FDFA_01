...
for(sex_int in Sex_int){
  if(sex_int=="M"){sex_nat="MIGIJ_Mest"}else{sex_nat="MIGIJ_Fest"}
  ...
  for(slice_n in Slice_n){
    ...
    copy_to(mig_db,
            GLOBAL_mig_int,
            name=paste0(c("GLOBAL_mig_int_X",slice_n,sex_int,"admin"),collapse = "_"),
            temporary = FALSE,
    ...
    copy_to(mig_db,
            GLOBAL_mig_nat,
            name=paste0(c("GLOBAL_mig_nat_X",slice_n,sex_int,"admin"),collapse = "_"),
            temporary = FALSE,
            indexes = list("JOIN_ID_I","JOIN_ID_J","ISOI","ISOJ"),
            overwrite = T)
    
    # print ###
    print(paste(sex_int,slice_n))
...
for(sex_int in Sex_int){
  ...
  for(slice_n in Slice_n){
    ...
    copy_to(mig_db,
            GLOBAL_mig_int,
            name=paste0(c("GLOBAL_mig_int_M",slice_n,sex_int,"admin"),collapse = "_"),
            temporary = FALSE,
            indexes = list("JOIN_ID_I","JOIN_ID_J","ISOI","ISOJ"),
            overwrite = T)
    ...
    copy_to(mig_db,
            GLOBAL_mig_nat,
            name=paste0(c("GLOBAL_mig_nat_M",slice_n,sex_int,"admin"),collapse = "_"),
            temporary = FALSE,
            indexes = list("JOIN_ID_I","JOIN_ID_J","ISOI","ISOJ"),
            overwrite = T)
